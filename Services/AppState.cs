...
internal static class AppState
{
    ...
    public static object? LoginPage { get; set; }
    ...
    public static async Task OpenUrlAsync(string url)
    {
        ...
        try
        {
            ...
            ShowStatus(Loc.T("AppState_Url_Opened"), InfoBarSeverity.Success);
        }
        catch
        {
            ShowStatus(Loc.T("AppState_Url_OpenFailed"), InfoBarSeverity.Error);
        }
    }
}
